      ...
      <div className="absolute inset-0 flex justify-center items-center">
        ...
        >
          ...
          <motion.div className="relative">
            <h1 className="text-7xl md:text-9xl text-transparent [-webkit-text-stroke:2px_#f5e6b9] uppercase leading-none tracking-tighter" style={{ fontFamily: "'Boldonse', sans-serif" }}>
